package com.qidaiai.aspectj;

import com.alibaba.fastjson.JSON;
import com.qidaiai.aspectj.annotation.Log;
import com.qidaiai.aspectj.enums.BusinessStatus;
...
import com.qidaiai.utils.ServletUtils;
...
public class OperLogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.qidaiai.aspectj.annotation.Log)")
